...
/***** DATAS *****/
// import moviesArticle from '../../datas/moviesArticle';
...
const Movie = () => {
    ...
    <div className="">
      ...
      <button className="btnMovie btnMovie--apache"><a href="https://vimeo.com/357378807" target="_blank">Voir le film</a></button>
    </div>
	);
}
